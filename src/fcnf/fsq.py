...
class FSQ(Module):
    def __init__(
        ...
        effective_codebook_dim = codebook_dim * num_codebooks    # ! important
        ...
        print(f">>>>>>> FSQ: input_dim={self.dim}, effective_codebook_dim={effective_codebook_dim}, has_projections={has_projections}")
        ...
        if return_indices:
            self.codebook_size = self._levels.prod().item()    # ! use for Transformer vocab size
